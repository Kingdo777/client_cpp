...
from rfittools.env import PROJ_ROOT, USABLE_CPUS, RFIT_RUNTIME_ROOT
from os.path import join, exists
from subprocess import run

from rfittools.build import build_config_cmd, WASM_LIB_INSTALL, WASM_SYSROOT
...
BUILD_PYTHON_BIN = "/home/kingdo/CLionProjects/client_cpp/runtime/python3.8/bin"
...
LIB_DEST_DIR = join(RFIT_RUNTIME_ROOT, "lib")
...
def build(ctx, clean=False, noconf=False, nobuild=False):
    ...
    link_libs = "-lc-printscan-long-double -lrfit"
