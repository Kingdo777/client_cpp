...
# Directories
RFIT_LOCAL_DIR = environ.get("RFIT_LOCAL_DIR", "/home/kingdo/CLionProjects/client_cpp/runtime")
RFIT_NATIVE_DIR = join(RFIT_LOCAL_DIR, "native")
WASM_SYSROOT = join(RFIT_LOCAL_DIR, "llvm-sysroot")
WASM_LIB_INSTALL = "{}/lib/wasm32-wasi".format(WASM_SYSROOT)
WASM_TOOLCHAIN_ROOT = "/home/kingdo/CLionProjects/client_cpp/runtime/toolchain"
